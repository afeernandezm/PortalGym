const añadirEjercicioPiernas = document.getElementById("añadirEjercicioPiernas");
const tablaPiernas = document.getElementById("tablaPiernas").getElementsByTagName("tbody")[0];

// Agregar un evento al botón de crear rutina
añadirEjercicioPiernas.addEventListener("click", function () {
    ...
    agregarBtn.addEventListener("click", function () {
        ...
        const nuevaFila = tablaPiernas.insertRow(-1);
